...
class Mubi(object):
    def __init__(self, email, password):
        ...
        self.user_id = self._login(email, password)

    def _login(self, email, password):
        login_html = self.s.get('https://mubi.com/login').content
        ...
        response = self.s.post('https://mubi.com/session', data=payload)
        ...
        if response.url == 'http://mubi.com/home':
            ...
            user_url = self.s.get('http://mubi.com/profile').url
